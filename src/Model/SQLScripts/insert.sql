...
insert OR REPLACE into accounts (descr, user_name) values ("Second", "Alisa");
...
insert OR REPLACE into records (descr, amount, create_time, category_name, account_id) values ("A new car1", 10000, 1433078606643, "Transport", 2);
insert OR REPLACE into records (descr, amount, create_time, category_name, account_id) values ("A new car2", 10000, 1433078606643, "Transport", 2);


insert OR REPLACE into records (descr, amount, create_time, category_name, account_id) values ("A cup of tea", 20, 1433078606643, "Food and Drinks", 3);
insert OR REPLACE into records (descr, amount, create_time, category_name, account_id) values ("A metro ticket", 35, 1433078606643, "Transport", 3);
